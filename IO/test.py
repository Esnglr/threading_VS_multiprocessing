...
threading_command = ["python3", "./IO/thread.py"] + urls + ["-o"] + filenames
...
multiprocessing_command = ["python3", "./IO/multiprocess.py"] + urls + ["-o"] + filenames
...
plt.title('IO Bound Task:Execution Time')
